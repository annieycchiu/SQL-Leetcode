...
with base as (
    select tb1.student_id, tb2.student_name, tb1.score,
           max(tb1.score) over (partition by tb1.exam_id) max_score,
           min(tb1.score) over (partition by tb1.exam_id) min_score
    from Exam tb1
    left join Student tb2
...
having sum(score = max_score or score = min_score) = 0
order by 1